...
namespace CombiConML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Source\newDataset.csv";
        private static string MODEL_FILEPATH = @"../../../../CombiConML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Concatenate("Features", new[] { "previousHit", "newHit" });

            // Set the training algorithm 
            var trainer = mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options() { NumberOfLeaves = 109, MinimumExampleCountPerLeaf = 10, NumberOfTrees = 500, LearningRate = 0.1844053f, Shrinkage = 0.9649469f, LabelColumnName = "directionChanged?", FeatureColumnName = "Features" });
        ...
        private static void Evaluate(MLContext mlContext, IDataView trainingDataView, IEstimator<ITransformer> trainingPipeline)
        {
            ...
            var crossValidationResults = mlContext.BinaryClassification.CrossValidateNonCalibrated(trainingDataView, trainingPipeline, numberOfFolds: 5, labelColumnName: "directionChanged?");
